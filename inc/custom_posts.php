...
function pwg_scorecard() {
	...
	register_post_type( 'pwg_scorecard', $args );
...
function pwg_golfcourse() {
	...
	register_post_type( 'pwg_golfcourse', $args );
...
function pwg_golfclub() {
	...
	register_post_type( 'pwg_golfclub', $args );
...
function pwg_holes() {
	...
	register_post_type( 'pwg_hole', $args );
